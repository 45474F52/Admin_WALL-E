...
namespace Admin_WALL_E.Core
{
    ...
    {
        private readonly ConcurrentDictionary<Type, SynchronizedCollection<Subscription>> Subscriptions =
            new ConcurrentDictionary<Type, SynchronizedCollection<Subscription>>();

        private readonly ConcurrentDictionary<Type, object> CurrentState = new ConcurrentDictionary<Type, object>();
